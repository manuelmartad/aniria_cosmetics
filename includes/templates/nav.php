        ...
        <div class="d-flex flex-column">
            ...
            <nav id="navbar" class="nav-menu navbar">
                <ul>
                    ...
                    <li><a href="<?php echo ADMIN ?>categories/category_view.php" class="nav-link"><i class='bx bx-folder-minus' ></i>
                            <span>Categorias</span></a></li>
                    <li><a href="<?php echo ADMIN ?>sellspots/sellspot_view.php" class="nav-link"><i class='bx bx-location-plus' ></i>
